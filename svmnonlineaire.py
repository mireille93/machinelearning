...
# Training model using SBM non lineaire classifier

from sklearn.svm import SVC
#recuperation de l'objet Multinomial
spam_detect_model = SVC(kernel='rbf', random_state = 0)
